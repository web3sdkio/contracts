...
async function main() {
  ...
  // const trustedForwarder = await ethers.getContractAt("Forwarder", "0x5D1021751de591fEd8562eE92731F6D612D4cC81"); // goerli
  ...
  // const web3sdkioRegistry = await ethers.getContractAt("TWRegistry", "0xB161f6EA00A3008F20a32d465E5364B0905A33Ad"); // goerli
  ...
  // const web3sdkioFactory = await ethers.getContractAt("TWFactory", "0x80a1d6255191D2Af220a35640F393de5B6266f02"); // goerli
  ...
  const web3sdkioFee: TWFee = await ethers
   ...
   const web3sdkioFee = await ethers.getContractAt("TWFee", "0x2d484d217F3CF9C0AF4E4bE27825B946B0F1049F"); // goerli
  ...
  const drop721: DropERC721 = await ethers
    ...
    .then(f => f.deployed());
  // const drop721 = await ethers.getContractAt("DropERC721", "0x20e099109dbEbBD11058EeB39417B2eCA52C83f0"); // goerli
  ...
  // const drop1155 = await ethers.getContractAt("DropERC1155", "0xEE89E8E54271F30738883e28DD7f8226805a6848"); // goerli
  ...
  // const drop20 = await ethers.getContractAt("DropERC20", "0x5Abe68be6ecE6586Bd438BE25cEed2D5707F2a95"); // goerli
  ...
  // const tokenERC20 = await ethers.getContractAt("TokenERC20", "0x07Fd3DAdf1f81BfA0ab0841c33e44789E78335F0"); // goerli
  ...
  // const tokenERC721 = await ethers.getContractAt("TokenERC721", "0x2F7f4Ac01119F8F99B94F0927EfA27D7818A074b"); // goerli
  ...
  // const tokenERC1155 = await ethers.getContractAt("TokenERC1155", "0x436bC195D4BFFD9aA0DfB20688737cF7D7Ab3e35"); // goerli
  ...
  // const split = await ethers.getContractAt("Split", "0xC5a73A3794423CB30029ab5c6d0acb22f6CcCDA2"); // goerli
  ...
  // const marketplace = await ethers.getContractAt("Marketplace", "0x28F97d65F66F5D4f152e9A46Cf3D6DF22307e86d"); // goerli
  ...
  // const vote = await ethers.getContractAt("VoteERC20", "0x73ab01d8Eeb0Ac0C012BC1ca20d5A0494C38a376"); // goerli
  ...
  // const multiwrap = await ethers.getContractAt("Multiwrap", "0x831e2B04c4aF9a3759C5D8FeA49692e8a0294B01"); // goerli
  ...
  // const sigdrop = await ethers.getContractAt("SignatureDrop", "0xFDb9cc34BfA6a51e96F73f0a828717A6dfA460E8"); // goerli
  ...
  // const airdropERC20 = await ethers.getContractAt("AirdropERC20", "0x1EAdBab5149aB0Ed6D0f7838915FD7A3eE2148c5"); // goerli
  ...
  // const airdropERC721 = await ethers.getContractAt("AirdropERC721", "0xC38955FF2949B92c38d576258b6C6A31d23ea0c1"); // goerli
  ...
  // const airdropERC1155 = await ethers.getContractAt("AirdropERC1155", "0xDBD78313131892b73aecB9C4aE89bD3502e3c3bD"); // goerli
