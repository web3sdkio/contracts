...
import "./mocks/MockWeb3sdkioContract.sol";
...
contract TWFactoryTest is ITWFactoryData, BaseTest {
    ...
    // Test params
    MockWeb3sdkioContract internal mockModule;
    ...
    function setUp() public override {
        ...
        mockModule = new MockWeb3sdkioContract();
    }
    ...
    function test_addImplementation_directV2() public {
        MockWeb3sdkioContractV2 mockModuleV2 = new MockWeb3sdkioContractV2();
    ...
    function test_deployProxyByImplementation(bytes32 _salt) public {
        ...
        assertEq(mockModule.contractType(), MockWeb3sdkioContract(computedProxyAddr).contractType());
    }
    ...
    function test_deployProxy() public {
        ...
        assertEq(mockModule.contractType(), MockWeb3sdkioContract(proxyAddr).contractType());
    }
